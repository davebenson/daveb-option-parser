...
ArgInfo.prototype.mandatory = function(isM) {
  this._mandatory = !!isM;
  return this;
};

ArgInfo.prototype.defaultValue = function(v) {
  this._defaultValue = v;
  return this;
}

ArgInfo.prototype.argPrototypeLabel = function(label) {
...
OptionParser.prototype.parse = function(args)
{
  ...
  for (var nname in this.nnameToArgInfo) {
    if (this.nnameToArgInfo[nname]._defaultValue !== undefined) {
      console.log("found default value fro " + nname);
  ...
  for (var arg in this.info) {
    if (this.info[arg]._mandatory && !(arg in this.values)) {
